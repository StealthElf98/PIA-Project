...
@Component({
  selector: 'app-tournament2',
  templateUrl: './tournament2.component.html',
  styleUrls: ['./tournament2.component.css']
})
export class Tournament2Component implements OnInit {
  ...
  constructor(private router:Router, private tournamentService:TournamentService, private sportService:SportService,
    ...
    ngOnInit(): void {
      ...
      this.tournamentService.getTournaments(this.user.username).subscribe((data:Tournament[])=>{
        this.tournament1 = data[1];
        if(data[1].sport != "Kosarka" && data[1].sport != "Odbojka" && data[1].sport != "Vaterpolo" 
        && data[1].sport != "Tenis"){
          this.athletes = data[1].athletes;
        this.br = data[1].athletes.length;
        this.button2 = true;
        if(data[1].format == '1 krug'){
          this.jedanKrug = true;
        }else if(data[1].format == "3 kruga"){
          this.triKruga = true;
        }else{
        ...
        this.tournamentService.getAllResults(this.tournament1.discipline, this.tournament1.sex).subscribe((results:Result[])=>{
          ...
          }else if(data[1].sport == "Kosarka" || data[1].sport == "Odbojka" || data[1].sport == "Vaterpolo"){
            this.ekipni = true;
