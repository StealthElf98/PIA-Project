...
@Component({
  selector: 'app-tournament3',
  templateUrl: './tournament3.component.html',
  styleUrls: ['./tournament3.component.css']
})
export class Tournament3Component implements OnInit {
  ...
  constructor(private router:Router, private tournamentService:TournamentService, private sportService:SportService,
    ...
    ngOnInit(): void {
      ...
      this.tournamentService.getTournaments(this.user.username).subscribe((data:Tournament[])=>{
        this.tournament1 = data[2];
        if(data[2].sport != "Kosarka" && data[2].sport != "Odbojka" && data[2].sport != "Vaterpolo" 
        && data[2].sport != "Tenis"){
          this.athletes = data[2].athletes;
        this.br = data[2].athletes.length;
        this.button2 = true;
        if(data[2].format == '1 krug'){
          this.jedanKrug = true;
        }else if(data[2].format == "3 kruga"){
          this.triKruga = true;
        }else{
        ...
        this.tournamentService.getAllResults(this.tournament1.discipline, this.tournament1.sex).subscribe((results:Result[])=>{
          ...
          }else if(data[2].sport == "Kosarka" || data[2].sport == "Odbojka" || data[2].sport == "Vaterpolo"){
            this.ekipni = true;
